...
cfg = {
    'DATASETS': {
        'NINAPRO_DB10': {
            ...
            'FORMATTED_DATA_PATH': 'data/formatted/iter6/ninapro_db10',
            'PROCESSED_DATA_PATH': 'data/processed/iter8/ninapro_db10',
            'DATA_COL_NAME': 'emg',
        ...
        'GRABMYO': {
            ...
            'FORMATTED_DATA_PATH': 'data/formatted/iter6/grabmyo_openhand',
            'PROCESSED_DATA_PATH': 'data/processed/iter8/grabmyo_openhand',
